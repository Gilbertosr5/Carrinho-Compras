let modelsJson = [
    {id:1, name:'F4F Wildcat', img:'img/F4FWildcat.png', price:[100.00, 150.00, 200.00], sizes:['1/144', '1/48', '1/32'], description:'Caça utilizado nos primeiros anos de combate no pacífico pela marinha dos EUA'},
    ...
    {id:3, name:'Ki 61 - Hien', img:'img/Ki61Hien.png', price:[100.00, 150.00, 200.00], sizes:['1/72', '1/37', '1/32'], description:'Caça fabricado pela Kawasaki para o exercito japones, com motor em linha'},
